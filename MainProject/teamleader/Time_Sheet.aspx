<%@ Page Language="C#" MasterPageFile="~/teamleader/MasterPage.master" AutoEventWireup="true" CodeFile="Time_Sheet.aspx.cs" Inherits="teamleader_Default" Title="Untitled Page" %>

<%@ Register src="../user_control/control_for_timesheet.ascx" tagname="control_for_timesheet" tagprefix="uc1" %>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td width="17%">
                                                                ...
                                                                <uc1:control_for_timesheet ID="control_for_timesheet1" runat="server" />
                                   ...
                                   <tr>
                                        <td  style="width:100%">
                                          <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                            <tr>
                                               <td width="10%">&nbsp;</td>
                                               <td width="40%" align="left"><b>Start&nbsp;Time:</b></td>
                                   ...
                                   <tr>
                                        <td  style="width:100%">
                                          <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                            <tr>
                                               <td width="10%">&nbsp;</td>
                                               <td width="40%" align="left"><b>End&nbsp;Time:</b></td>
