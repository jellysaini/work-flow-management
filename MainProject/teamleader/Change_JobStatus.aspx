<%@ Page Language="C#" MasterPageFile="~/teamleader/MasterPage.master" AutoEventWireup="true" CodeFile="Change_JobStatus.aspx.cs" Inherits="teamleader_Default" Title="Untitled Page" %>
                                                     ...
                                                     <td width="100%" >
                                                           ...
                                                           <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:DropDownList ID="drp_new_status" runat="server" 
                                                                                CssClass="fordrp" AutoPostBack="true" 
                                                                                onselectedindexchanged="drp_new_status_SelectedIndexChanged"></asp:DropDownList></td>
                                                                    </tr>
                                                            </table>
