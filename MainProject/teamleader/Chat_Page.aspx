<%@ Page Language="C#" MasterPageFile="~/teamleader/MasterPage.master" AutoEventWireup="true" CodeFile="Chat_Page.aspx.cs" Inherits="teamleader_Default" Title="Untitled Page" %>
                        ...
                        <table width="100%">
                            <tr>
                             <td style="width:58%" align="right">
                                        <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="Blue" onclick="logout_Click" ><b>Logout 
