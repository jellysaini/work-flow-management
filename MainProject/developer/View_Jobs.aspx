<%@ Page Language="C#" MasterPageFile="~/developer/MasterPage.master" AutoEventWireup="true" CodeFile="View_Jobs.aspx.cs" Inherits="developer_Default" Title="Untitled Page" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:94%" align="center">
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"> 
                                                            <tr>
                                                                <td align="center">
                                                                    <asp:DataList ID="datalist_for_ViewJobs" runat="server" DataKeyField="JobId" ondeletecommand="datalist_for_ViewJobs_DeleteCommand" 
                                                                       >
                                                                            <HeaderTemplate>
