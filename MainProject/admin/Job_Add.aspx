<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="Job_Add.aspx.cs" Inherits="admin_Default" Title="Untitled Page" %>
                                                                                                            ...
                                                                                                            <td width="100%">
                                                                                                                ...
                                                                                                                <!--    <asp:UpdatePanel ID="upd" runat="server"><ContentTemplate> -->
                                                                                                                        <asp:DropDownList ID ="drpAccountingFirm" CssClass ="txt" runat="server" 
                                                                                                                            DataTextField="FirmName" DataValueField="FirmId" AutoPostBack="True" onselectedindexchanged="drpAccountingFirm_SelectedIndexChanged1" 
                                                                                                                            ></asp:DropDownList></td>
                                                                                                                        ...
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:50%" align="right">
                                                                                                                                    <asp:TextBox ID="txtBenchmarking" runat="server" CssClass="txt1"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td style="width:100%">
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:50%" align="right">
                                                                                                                                    <asp:TextBox ID="txtCashFlowForecast" runat="server" CssClass="txt1"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td style="width:100%">
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:50%" align="right">
                                                                                                                                    <asp:TextBox ID="txtProfitOptimizer" runat="server" CssClass="txt1"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td style="width:100%">
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:50%" align="right">
                                                                                                                                    <asp:TextBox ID="txtAnnualReturn" runat="server" CssClass="txt1"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td style="width:100%">
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:50%" align="right">
                                                                                                                                    <asp:TextBox ID="txtOther" runat="server" CssClass="txt1"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td style="width:100%">
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:50%" align="right">
                                                                                                                                    <asp:TextBox ID="txtAccounts" runat="server" CssClass="txt1"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                 ...
                                                                                                                 <tr>
                                                                                                                    <td style="width:100%">
                                                                                                                        <table border="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                <td style="width:50%" align="left">
                                                                                                                                    <asp:CheckBox ID="chk_GST_ret" runat="server" Text="GST&nbsp;Return" />
                                                                                                                                </td>
                                                                                                                                <td style="width:50%" align="right">
