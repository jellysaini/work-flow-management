<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="Firm_Edit.aspx.cs" Inherits="admin_Default" Title="Untitled Page" %>
                        ...
                        <tr>
                            ...
                            <td style="width:80%">
                                         <fieldset id="fsAddFirm">
                                                <legend class="fontForOuterLegend">Edit Firm</legend>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    ...
                                                                    <tr align="center">
                                                                        ...
                                                                        <td width="20%" align="left"><asp:TextBox ID="txtAccounts" CssClass="txtShort" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr align="center">
                                                                        ...
                                                                        <td width="20%" align="left"><asp:TextBox ID="txtTaxReturn" CssClass="txtShort" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr align="center"><td width="30%">GST&nbsp;Return</td>
                                                                        ...
                                                                        <td width="20%" align="left"><asp:TextBox ID="txtGSTReturn" CssClass="txtShort" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                    ...
                                    <fieldset id="Fieldset2" style="height:250px">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:TextBox ID="txtBenchmarking" CssClass="txt" runat="server" TextMode="MultiLine"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:TextBox ID="txtCashFlowForecast" CssClass="txt" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:TextBox ID="txtProfitOptimizer" CssClass="txt" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:TextBox ID="txtAnnualCompanyReturn" CssClass="txt" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:TextBox ID="txtHourlyFee" CssClass="txt" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:TextBox ID="txtOtherFee" CssClass="txt" runat="server"></asp:TextBox></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="width:2%">&nbsp;</td>
                                                            <td style="width:46%" valign="top">
                                                                 <fieldset id="fsDescription" style="height:230px">
                                                 ...
                                                 <fieldset id="fsFirmStatus" style="height:113px" >
                                                <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                                                                   
                                                    <legend class="fontForInnerLegend" >Firm Status</legend>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr><td>&nbsp;</td></tr>
                                                       <tr valign="top">
                                                           <td style="width:100%">
                                                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                  <tr align="center">
                                                                     ...
                                                                     <td style="width:70%;" align="left">
                                                                         <asp:DropDownList ID="drpStatus" CssClass="fordrp" runat="server" 
                                                                             AutoPostBack="True" DataTextField="StatusLevel" DataValueField="StatusId"></asp:DropDownList>
                                                                     </td>
                                                                  </tr>
                                                              </table>
                                                           </td>
