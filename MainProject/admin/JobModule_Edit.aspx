<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="JobModule_Edit.aspx.cs" Inherits="admin_Default" Title="Untitled Page" %>
                                                       ...
                                                       <td width="100%" >
                                                           <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="2%">&nbsp;</td>
                                                                        <td width="60%"><asp:DropDownList ID="drpModuleType" DataTextField="WorkType" DataValueField="id" runat="server" CssClass="fordrp"></asp:DropDownList></td>
                                                                    </tr>
                                                            </table>
                                                       </td>
                                                   </tr>
